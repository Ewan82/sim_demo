...
def extract_state_arr(state_crop_csv, state_sm_dir, point_no, fdir=None, point_level='high'):
    ...
    sm_csv1 = glob.glob(state_sm_dir + '/' + file_head +'*SM.csv')[0]
    ...
    sm_mean = np.nanmean((sm1_port1, sm1_port2), axis=0)
    sm_std = np.nanstd((sm1_port1, sm1_port2), axis=0)
...
def extract_state_sat_csv(field_no, point_level, save_dir):
    ...
    extract_s1_data('/export/cloud/nceo/users/if910917/sentinel_data/S1/munich/S1_LMU_site_2017_new.nc', lat, lon,
                    ...
                    remove_pol=1)
    extract_s1_data('/export/cloud/nceo/users/if910917/sentinel_data/S1/munich/S1_LMU_site_2017_new.nc', lat, lon,
                    save_dir+'mni_s1_' + str(field_no) + '_' + str(point_level) + '_vv.csv', (dates[0], dates[-1]),
                    remove_pol=0)
    extract_s1_data('/export/cloud/nceo/users/if910917/sentinel_data/S1/munich/S1_LMU_site_2017_new.nc', lat, lon,
                    save_dir+'mni_s1_' + str(field_no) + '_' + str(point_level) + '_hvvv.csv', (dates[0], dates[-1]))
    ...
    extract_s2_data('/export/cloud/nceo/users/if910917/sentinel_data/S2/munich/MNI_181001.nc', lat, lon,
                    ...
                    (dates[0], dates[-1]), remove_bnds=(0,1,2,9,10,11,12))
...
def extract_state_sat_508_latlon_csv(lat, lon, save_dir, sname):
    ...
    extract_s1_data('/export/cloud/nceo/users/if910917/sentinel_data/S1/munich/S1_LMU_site_2017_new.nc', lat, lon,
                    ...
                    remove_pol=1)
    extract_s1_data('/export/cloud/nceo/users/if910917/sentinel_data/S1/munich/S1_LMU_site_2017_new.nc', lat, lon,
                    save_dir+'mni_s1_' + sname + '_vv.csv', (dates[0], dates[-1]),
                    remove_pol=0)
    extract_s1_data('/export/cloud/nceo/users/if910917/sentinel_data/S1/munich/S1_LMU_site_2017_new.nc', lat, lon,
                    save_dir+'mni_s1_' + sname + '_hvvv.csv', (dates[0], dates[-1]))
    print 'extracted S1 data!'
    extract_s2_data('/export/cloud/nceo/users/if910917/sentinel_data/S2/munich/MNI_181001.nc', lat, lon,
...
def extract_state_sat_ita_latlon_csv(lat, lon, save_dir, sname):
    ...
    extract_s1_data('/export/cloud/nceo/users/if910917/sentinel_data/S1/italy/foggia_italy_processed.nc', lat, lon,
                    ...
                    remove_pol=1)
    extract_s1_data('/export/cloud/nceo/users/if910917/sentinel_data/S1/italy/foggia_italy_processed.nc', lat, lon,
                    save_dir+'ita_s1_' + sname + '_vv.csv', (dates[0], dates[-1]),
                    remove_pol=0)
    extract_s1_data('/export/cloud/nceo/users/if910917/sentinel_data/S1/italy/foggia_italy_processed.nc', lat, lon,
                    save_dir+'ita_s1_' + sname + '_hvvv.csv', (dates[0], dates[-1]))
    print 'extracted S1 data!'
...
def extract_state_sat_csv_2017(field_no, point_level, save_dir):
    ...
    print 'extracted state variables!'
    extract_s1_data('/export/cloud/nceo/users/if910917/sentinel_data/S1/munich/S1_LMU_site_2017_new.nc', lat, lon,
                    save_dir+'mni_s1_' + str(field_no) + '_' + str(point_level) + '_2017.csv', remove_pol=1)
    print 'extracted S1 data!'
    extract_s2_data('/export/cloud/nceo/users/if910917/sentinel_data/S2/munich/MNI_181001.nc', lat, lon,
